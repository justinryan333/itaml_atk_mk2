...
import sys
sys.path.append('C:/Users/justi/PycharmProjects/iTAML_ATK_Mk1')  # Add the root directory or path to where data_bd.py is located
from data_bd import PoisonedCIFAR10  # Now you can import PoisonedCIFAR10 class
...
class IncrementalDataset:
    def __init__(
        ...
        datasets = _get_dataset(dataset_name)  # This will now return PoisonedCIFAR10 for 'poisoned_cifar10'
...
def _get_dataset(dataset_name):
    ...
    if dataset_name == "cifar10":
        return iCIFAR10
    elif dataset_name == "poisoned_cifar10":  # Added condition for poisoned CIFAR-10
        return PoisonedCIFAR10  # Use the poisoned dataset class
